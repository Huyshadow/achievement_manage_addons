...
class AchievementUser(models.Model):
    ...
    achievement_id = fields.Many2one('create_achievement.achievement', string="ID danh hiệu")
    submit_list = fields.One2many('achievement.submit', 'parent_id', string='Danh sách hồ sơ nộp')
