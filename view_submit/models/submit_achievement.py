...
class Achievement(models.Model):
    ...
    num_of_user = fields.Char(
        string="Số lượng đã duyệt/đã nộp", compute="_compute_num_of_user")
    num_of_current = fields.Integer(default=0)
    num_of_total = fields.Integer(default=0)
